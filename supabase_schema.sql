-- ==============================================
-- SUPABASE DATABASE SCHEMA FOR AITRION PROJECT
-- ==============================================
-- Copy and paste this entire script into the Supabase SQL Editor
-- to create all required tables for the dashboard migration
...
CREATE TABLE IF NOT EXISTS ai_config (
    ...
    length_limit TEXT DEFAULT 'MEDIUM', -- SHORT (≤120), MEDIUM (≤250), LONG (≤400)
...
SELECT 'Database schema created successfully! All tables, indexes, and triggers have been set up.' as message;